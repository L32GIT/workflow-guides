## Введение
**Подпись коммита с помощью электронной цифровой подписи** - это действие, которое дополняет коммит однозначно верифицируемой информацией об его авторе.  
